...
dem diese Abhängigkeit umgekehrt ist. Dies wird deutlich beim Vergleich des Schemas mit den
tatsächlichen Modulabhängigkeiten (siehe Abb. \ref{module-dependency-graph} im Anhang).
Dies stellt für den Moment eine vernachlässigbare Designschwäche dar die ohne weitere
